...
<div class="text-center btn-group d-flex justify-content-center d-md-table mx-auto p-5">
    <a href="createe.php" ><button class="btn btn-outline-info" >Click to Add a record</button></a>
    <a href="view.php" ><button class="btn btn-outline-success" >Click to View a record</button></a>
